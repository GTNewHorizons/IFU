...
public abstract class AbstractMessage<T extends AbstractMessage<T>> implements IMessage, IMessageHandler<T, IMessage> {
    ...
    /**
     * Some PacketBuffer methods throw IOException - default handling propagates the exception. if an IOException is
     * expected but should not be fatal, handle it within this method.
     */
    ...
    /**
     * Called on whichever side the message is received; for bidirectional packets, be sure to check side
     */
