...
public class DNItemArmor extends Item
{
    /** Holds the 'base' maxDamage that each armorType have. */
    private static final int[] maxDamageArray = new int[] {11, 16, 15, 13};
    private static final String[] CLOTH_OVERLAY_NAMES = new String[] {"leather_helmet_overlay", "leather_chestplate_overlay", "leather_leggings_overlay", "leather_boots_overlay","leather_boots_backpack"};
    public static final String[] EMPTY_SLOT_NAMES = new String[] {"empty_armor_slot_helmet", "empty_armor_slot_chestplate", "empty_armor_slot_leggings", "empty_armor_slot_boots","empty_armor_slot_bacpack"};
    ...
    private final DNItemArmor.ArmorMaterial material;
    ...
    public DNItemArmor(DNItemArmor.ArmorMaterial p_i45325_1_, int p_i45325_2_, int p_i45325_3_)
    {
    ...
    {
        return this.material == DNItemArmor.ArmorMaterial.CLOTH;
    }
     ...
     */
    public DNItemArmor.ArmorMaterial getArmorMaterial()
    {
    ...
    {
        return this.material != DNItemArmor.ArmorMaterial.CLOTH ? false : (!p_82816_1_.hasTagCompound() ? false : (!p_82816_1_.getTagCompound().hasKey("display", 10) ? false : p_82816_1_.getTagCompound().getCompoundTag("display").hasKey("color", 3)));
    }
    ...
    {
        if (this.material != DNItemArmor.ArmorMaterial.CLOTH)
        {
            return -1;
        }
        else
...
/*    @SideOnly(Side.CLIENT)
    ...
    public static enum ArmorMaterial
    {
        ...
        {
            return DNItemArmor.maxDamageArray[p_78046_1_] * this.maxDamageFactor;
        }
